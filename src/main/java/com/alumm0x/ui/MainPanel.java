...
// //                logTable.setAutoCreateRowSorter(true);
        ...
        constraints.gridwidth = GridBagConstraints.REMAINDER;    //结束行
        // 添加复选框按钮
        makeButton("All",options,gbaglayout,constraints, myItemListener).setToolTipText("启动所有的Task");
        constraints.gridwidth = GridBagConstraints.REMAINDER;    //结束行
        makeButton("Api",options,gbaglayout,constraints, myItemListener).setToolTipText("主要是探测漏洞Api是否存在");
        constraints.gridwidth = GridBagConstraints.REMAINDER;    //结束行
    ...
    public static JCheckBox makeItercept(String title,JPanel jPanel,GridBagLayout gridBagLayout,GridBagConstraints constraints, MyItemListener itemListener)
    {
    ...
    public static JCheckBox makeButton(String title,JPanel jPanel,GridBagLayout gridBagLayout,GridBagConstraints constraints, MyItemListener itemListener)
    {
        JCheckBox button=new JCheckBox(title);
        button.setSelected(false); //默认不选中
        button.addItemListener(itemListener); //加入监听
